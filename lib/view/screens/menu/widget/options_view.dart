                ...
                child: SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (!kIsWeb)
                        ListTile(
                          onTap: () => Get.navigator!.push(MaterialPageRoute(
                              builder: (context) => const ScannerScreen())),
                          leading: Image.asset(Images.scanner,
                              width: 20,
                              height: 20,
                              color:
                                  Theme.of(context).textTheme.bodyLarge!.color),
                          title: Text(getTranslated('qr_scan', context)!,
                              style: rubikMedium.copyWith(
                                  fontSize: Dimensions.fontSizeLarge)),
                        ),
                      ListTile(
                        ...
                        Consumer<ProfileProvider>(
                          ...
                          return profileProvider.userInfoModel != null &&
                              ...
                              ? ListTile(
                                  ...
                                  leading: Image.asset(Images.referralIcon,
                                      width: 20,
                                      height: 20,
                                      color: Theme.of(context)
                                          .textTheme
                      ...
                      if (configModel.walletStatus!)
                        ListTile(
                          ...
                          leading: Image.asset(Images.wallet,
                              width: 20,
                              height: 20,
                              color:
                                  Theme.of(context).textTheme.bodyLarge!.color),
                        ...
                        ListTile(
                          ...
                          leading: Image.asset(Images.loyaltyIcon,
                              ...
                              color: Theme.of(context)
                                  ...
                                  .color!
                                  .withOpacity(0.6)),
                          title: Text(getTranslated('loyalty_point', context)!,
                              style: rubikMedium.copyWith(
                                  fontSize: Dimensions.fontSizeLarge)),
                        ),
                      ListTile(
