                              ...
                              : TextButton(
                                  ...
                                  child: Builder(builder: (context) {
                                    ...
                                    Duration duration = Duration(
                                        seconds: authProvider.currentTime ?? 0);
                                    ...
                                    onTap: () {
                                      if (widget.fromSignUp) {
                                        if (config.customerVerification!
                                                .status! &&
                                            config.customerVerification!.type ==
                                                'phone') {
                                          authProvider
                                              .verifyPhone(
                                        ...
                                        } else if (config.customerVerification!
                                                .status! &&
                                            config.customerVerification!.type ==
                                                'email') {
                                          authProvider
                                      ...
                                      } else if (widget.fromSignUp == false) {
                                        // authProvider
                                        //       .verifyPhone(
                                        //           widget.emailAddress.trim())
                                        //       .then((value) {
